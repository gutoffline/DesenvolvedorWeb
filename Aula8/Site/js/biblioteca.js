...
//setTimeout --> Executa apenas uma única vez após o tempo determinado
//setTimeout(function(){Mensagem("Hello");}, 3000);

//setInterval --> Executa à cada X milisegundos
//setInterval(function(){Mensagem("Hello2");}, 3000);

var ListaBanners = ["#banner1","#banner2","#banner3"];
var ListaBotoes = ["#BotaoBanner1", "#BotaoBanner2","#BotaoBanner3"];
var contador = 0;
function BannerAutomatico(){
  ...
  console.log("CONTADORRRRRRRRRRRRR");
  console.log(contador);
  console.log("Banner Trocado");
  MudarBanner(ListaBanners[contador],ListaBotoes[contador]);
}

setInterval(function(){BannerAutomatico();}, 5000);
